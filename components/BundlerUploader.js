...
export const BundlrUploader = () => {
	...
	const [licenseFeeType, setLicenseFeeType] = useState("None");
	const [licenseFeeUnit, setLicenseFeeUnit] = useState(0);

	const [commercialUse, setCommercialUse] = useState("None");
	const [currency, setCurrency] = useState("U");
	const [paymentAddress, setPaymentAddress] = useState("");
	const [derivation, setDerivation] = useState("None");
